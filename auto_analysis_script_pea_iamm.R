...
wd <- "D:/qiq/2019-01-07_MO_PEA_IAMM_MIX/Flipped/auto_trials/PEA+IAMM/"
setwd(wd)
library(wholebrain)
...
datasets <- NULL
#load(file=paste0(wd, '/datasets/', tools::file_path_sans_ext(basename(images[143])), '_accum_dataset.RData'))
...
#save(file=paste0(wd, "/datasets/auto_pea_iamm_datasets_accum.Robj"), datasets_accum)
