...
```{r}
wd <- "C:/Users/kk2252/Desktop/3channel_test/"
setwd(wd)
library(wholebrain)
library(dplyr)
library(naturalsort)
...
```{r}
load(file= "D:/qiq/2019-01-07_MO_PEA_IAMM_MIX/Flipped/saved_filter/initial_filters_qiang.RData")
brain_seg$filter$resize <- 0.08
#brain_seg$filter$Max <- 10000
#brain_seg$filter$Max <- 3000
brain_seg$filter$Max <- 13000
```
