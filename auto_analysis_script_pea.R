...
wd <- "D:/qiq/2019-01-07_MO_PEA_IAMM_MIX/Flipped/auto_trials/PEA/"
setwd(wd)
library(wholebrain)
...
#datasets <- NULL
#load(file=paste0(wd, '/datasets/', tools::file_path_sans_ext(basename(images[131])), '_accum_dataset.RData'))
...
#datasets_accum$animal <- "PEA_auto"
#save(file=paste0(wd, "/datasets/auto_pea_datasets_accum.Robj"), datasets_accum)
write.table(file=paste0(wd, "/datasets/auto_pea_datasets_accum.tsv"), datasets_accum, sep = ",")
